...
* AmigaOS builds using [**Amiga‑GCC**](https://franke.ms/amiga/amiga-gcc.wiki)
  perform **UNIX‑style** internal wildcard expansion (*i.e.*, `*` and `?`).
  Builds using other Amiga toolchains ***do not*** support wildcard expansion
  at this time.
