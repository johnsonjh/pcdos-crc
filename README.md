...
- [Platform specifics](#platform-specifics)
  ...
  * [Building for 2.11BSD](#building-for-211bsd)
    + [2.11BSD notes](#211bsd-notes)
- [Security](#security)
...
* CP/M‑80 builds using supported compilers (`z88dk`, HI‑TECH C Z80, and Ack)
  support internal wildcard expansion (*i.e.*, `*` and `?`).  Other compilers
...
* CP/M‑86 builds using supported compilers (Aztec C) support internal wildcard
  expansion (*i.e.*, `*` and `?`).  Other compilers may need adaptations.
...
* CP/M‑68K builds using supported compilers (Aztec C) support internal wildcard
  expansion (*i.e.*, `*` and `?`).  Other compilers may need adaptations.
...
* **Ack** versions before 2026‑07‑16 have a
  ...
  was accepted.  It is highly recommended to always use the *very latest*
  version of Ack (on *all* platforms, not just MS‑DOS) due
  to [other](https://github.com/davidgiven/ack/issues/369)
  [bugs](https://github.com/davidgiven/ack/issues/367) that have
  been [recently](https://github.com/davidgiven/ack/pull/370) identified and
