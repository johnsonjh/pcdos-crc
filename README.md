...
* MS‑DOS builds using DJGPP, Aztec&nbsp;C86, Computer&nbsp;Innovations C86PLUS,
  HI‑TECH Pacific&nbsp;C, Microsoft&nbsp;C, Turbo&nbsp;C&nbsp;2.01, and all
  versions of Turbo&nbsp;C++ support internal wildcard expansion (*i.e.*, `*`
  and `?`).  Wildcard support for other MS‑DOS compilers may be added in a
  future release.
